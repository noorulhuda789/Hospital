...
{
	public class SignUpPatientController : Controller
	{
		private readonly HealthHubDbContext _context;
		public SignUpPatientController(HealthHubDbContext context)
		{
			_context = context;
		}
		public IActionResult SignUpPatient()
		{
        ...
        [HttpPost]
        public async Task<IActionResult> SignUpPatient(Person person)
        {
